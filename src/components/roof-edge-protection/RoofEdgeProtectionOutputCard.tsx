...
const RoofEdgeProtectionOutputCard = ({ roofEdgeDecteionData, title }: any) => {
  return (
    <>
      <div className={`flex flex-col border text-center items-center  w-[300px]  h-[100px]  justify-center py-3  px-8 gap-3 ${roofEdgeDecteionData?.
        isDetected
      ...
      <div className={`flex flex-col border items-center w-[300px] h-[100px] justify-center py-3  px-8  gap-3 ${roofEdgeDecteionData?.
