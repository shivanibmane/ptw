...
const RoofEdgeProtectionInput = () => {
  const { handleFileUpload, handleFileDelete, roofEdgeProtectionFile, setRoofEdgeProtectionFile,
    roofEdgeProtectionUrl, setRoofEdgeProtectionsetUrl, setIsSelectedVerificationFile, verificationInputData }: any = useContext(AppContext)
  ...
  return (
    <div className="px-3 mt-3">
      <div className="space-y-3 mt-3">
        ...
        />{roofEdgeProtectionFile && <Button variant="destructive" className="my-2" onClick={() => verificationInputData("/roof-edge-protection", { roofEdgeProtectionUrl: roofEdgeProtectionUrl })}>Process</Button>}
      </div>
    </div>
  )
}
